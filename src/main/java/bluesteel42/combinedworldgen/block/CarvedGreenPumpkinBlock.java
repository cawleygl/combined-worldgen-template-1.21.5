...
import bluesteel42.combinedworldgen.entity.GreenPumpkinSnowGolemEntity;
...
public class CarvedGreenPumpkinBlock extends HorizontalFacingBlock {
    ...
    private static final Predicate<BlockState> IS_GOLEM_HEAD_PREDICATE = state -> state != null
            && (state.isOf(ModBlocks.CARVED_GREEN_PUMPKIN) || state.isOf(ModBlocks.GREEN_JACK_O_LANTERN));
